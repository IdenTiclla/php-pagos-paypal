        ...
        <div class="row justify-content-center mt-5 pt-5">
            ...
            <div class="col-sm-12">
                <div class="card text-left">
                    ...
                    <!-- ---------------------------------------------------------------- -->
                    <div class="card-body">
                        <form action="frmcliente.php" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-md btn-dark m-0 px-3 py-2 z-depth-0 waves-effect" type="submit" name="btnbuscar" id="btnbuscar"><i class="fas fa-search pr-2" aria-hidden="true"></i>Buscar por nombre</button>
                                </div>
                            </div>
                        ...
                        <br>
                        <a class="btn btn-dark" href="frmabmcliente.php?op=1" role="button"><i class="fas fa-user-plus pr-2" aria-hidden="true"></i>Adicionar</a>
                        <hr class="bg-info">
